...
@Component({
  selector: 'app-programacion-autocomplete',
  templateUrl: './programacion-autocomplete.component.html',
  styleUrls: ['./programacion-autocomplete.component.css']
})
export class ProgramacionAutocompleteComponent  implements OnInit {
